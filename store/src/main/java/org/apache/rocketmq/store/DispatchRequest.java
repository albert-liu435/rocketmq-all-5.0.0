...
public class DispatchRequest {
    ...
    //12）long preparedTransactionOffset：消息预处理事务偏移
    //量。
    private final long preparedTransactionOffset;
    //13）Map propertiesMap：消息属性。
    //14）byte bitMap[]：位图。11）int sysFlag：消息系统标记。
    //12）long preparedTransactionOffset：消息预处理事务偏移
    //量。
    //13）Map propertiesMap：消息属性。
    //14）byte bitMap[]：位图。
